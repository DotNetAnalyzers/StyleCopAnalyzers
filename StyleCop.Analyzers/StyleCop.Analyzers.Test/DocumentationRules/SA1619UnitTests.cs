...
";
            await VerifyCSharpDiagnosticAsync(testCode.Replace("##", p), testSettings, EmptyDiagnosticResults, CancellationToken.None).ConfigureAwait(false);
        }
...
";
            ...
            await VerifyCSharpDiagnosticAsync(testCode, testSettings, EmptyDiagnosticResults, CancellationToken.None).ConfigureAwait(false);
        }
