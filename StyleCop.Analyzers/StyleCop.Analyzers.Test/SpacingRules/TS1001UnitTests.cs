...
namespace StyleCop.Analyzers.Test.SpacingRules
{
   ...
   /// </summary>
   public class TS1001UnitTests : CodeFixVerifier
   {
      [Fact]
...
";
         ...
         {
            this.CSharpDiagnostic(DescriptorNotFollowed).WithLocation(8, 23),
         };
      ...
      {
         yield return new TS1001ClosingParenthesisMustBePrecededByASpace();
      }
