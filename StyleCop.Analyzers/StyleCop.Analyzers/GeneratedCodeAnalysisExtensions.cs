...
namespace StyleCop.Analyzers
{
    ...
    internal static class GeneratedCodeAnalysisExtensions
    {
        ...
        /// </returns>
        public static bool IsGeneratedDocument(this SyntaxTree tree, StyleCopSettings settings, ConcurrentDictionary<SyntaxTree, bool> cache, CancellationToken cancellationToken)
        {
            if (tree == null)
            {
                return false;
            ...
            bool generated = IsGeneratedDocumentNoCache(settings, tree, cancellationToken);
        ...
        /// </summary>
        /// <remarks>
        /// <para>This method uses <see cref="IsGeneratedDocument(SyntaxTree, StyleCopSettings, ConcurrentDictionary{SyntaxTree, bool}, CancellationToken)"/> to determine which
        ...
        {
            return IsGeneratedDocument(context.Node.SyntaxTree, context.GetStyleCopSettings(), cache, context.CancellationToken);
        }
        ...
        {
            return IsGeneratedDocument(context.Tree, context.GetStyleCopSettings(), cache, context.CancellationToken);
        }

        private static bool IsGeneratedDocumentNoCache(StyleCopSettings settings, SyntaxTree tree, CancellationToken cancellationToken)
        {
            return IsGeneratedFileName(settings, tree.FilePath)
        ...
        /// <see langword="false"/>.</para>
        /// </returns>
        /// <seealso cref="IsGeneratedDocument(SyntaxTree, StyleCopSettings, ConcurrentDictionary{SyntaxTree, bool}, CancellationToken)"/>
        private static bool IsGeneratedFileName(StyleCopSettings settings, string filePath)
        {
            return settings.GeneratedFileFilters.Any(fileFilter => Regex.IsMatch(filePath, fileFilter, RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture));
        }
