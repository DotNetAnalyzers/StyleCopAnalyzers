namespace StyleCop.Analyzers.LayoutRules
{
    ...
    /// </summary>
    [ExportCodeFixProvider(nameof(SA1500CodeFixProvider), LanguageNames.CSharp)]
    [Shared]
    public class SA1500CodeFixProvider : CodeFixProvider
    {
        ...
        public override Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            {
                context.RegisterCodeFix(new PreservingDocumentChangeAction("Align curly brackets", token => GetTransformedDocumentAsync(context.Document, diagnostic, token)), diagnostic);
            }
