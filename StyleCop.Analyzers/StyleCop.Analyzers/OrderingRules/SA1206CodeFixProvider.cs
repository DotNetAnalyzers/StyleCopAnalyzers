...
namespace StyleCop.Analyzers.OrderingRules
{
    ...
    using static StyleCop.Analyzers.OrderingRules.KeywordOrderHelper;
    ...
    internal sealed class SA1206CodeFixProvider : CodeFixProvider
    {
        ...
        public override Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            foreach (Diagnostic diagnostic in context.Diagnostics)
            {
                context.RegisterCodeFix(
                    CodeAction.Create(
                        OrderingResources.KeywordOrderCodeFix,
        ...
        private class FixAll : DocumentBasedFixAllProvider
        {
            ...
            protected override string CodeActionTitle => OrderingResources.KeywordOrderCodeFix;
