namespace StyleCop.Analyzers.DocumentationRules
{
    ...
    public class SA1608ElementDocumentationMustNotHaveDefaultSummary : DiagnosticAnalyzer
    {
        ...
        internal const string Title = "The <summary> tag within an element's XML header documentation contains the default text generated by Visual Studio during the creation of the element.";
        internal const string MessageFormat = "TODO: Message format";
        internal const string Category = "StyleCop.CSharp.DocumentationRules";
        internal const string Description = "The <summary> tag within an element's XML header documentation contains the default text generated by Visual Studio during the creation of the element.";
        internal const string HelpLink = "http://www.stylecop.com/docs/SA1608.html";
