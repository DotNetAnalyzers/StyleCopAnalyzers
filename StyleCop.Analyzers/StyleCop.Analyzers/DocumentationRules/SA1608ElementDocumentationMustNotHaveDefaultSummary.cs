...
namespace StyleCop.Analyzers.DocumentationRules
{
    ...
    internal class SA1608ElementDocumentationMustNotHaveDefaultSummary : ElementDocumentationBase
    {
        ...
        private const string Title = "Element documentation should not have default summary";
        private const string MessageFormat = "Element documentation should not have default summary";
