    ...
    public class SA1011CodeFixProvider : CodeFixProvider
    {
        ...
        public override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            foreach (var diagnostic in context.Diagnostics)
            {
                ...
                context.RegisterCodeFix(CodeAction.Create(SpacingResources.SA1011CodeFix, t => GetTransformedDocumentAsync(context.Document, root, token), equivalenceKey: nameof(SA1011CodeFixProvider)), diagnostic);
            }
        }
