// <auto-generated/>
// https://raw.githubusercontent.com/dotnet/roslyn-analyzers/84fb81c27e0554eadf6b12f97eb52c7cd2803c7e/src/Utilities/Refactoring/AbstractRefactoringHelpers%603.cs
...
{
    internal abstract class AbstractRefactoringHelpers<TExpressionSyntax, TArgumentSyntax, TExpressionStatementSyntax>
        : IRefactoringHelpers
        ...
        where TExpressionStatementSyntax : SyntaxNode
    {
        ...
        private static bool IsWantedTypeExpressionLike<TSyntaxNode>() where TSyntaxNode : SyntaxNode
        {
            ...
            {
                return a.GetTypeInfo().IsSubclassOf(b) || a == b;
            }
        }
        ...
        /// </summary>
        protected virtual IEnumerable<SyntaxNode> ExtractNodesInHeader(SyntaxNode root, int location, ISyntaxFacts syntaxFacts)
        {
