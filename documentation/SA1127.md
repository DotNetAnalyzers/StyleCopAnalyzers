...
```csharp
[SuppressMessage("StyleCop.CSharp.ReadabilityRules", "SA1127:GenericTypeConstraintsMustBeOnOwnLine", Justification = "Reviewed.")]
```

```csharp
#pragma warning disable SA1127 // GenericTypeConstraintsMustBeOnOwnLine
#pragma warning restore SA1127 // GenericTypeConstraintsMustBeOnOwnLine
```
