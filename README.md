...
The severity of individual rules may be configured using [rule set files](https://msdn.microsoft.com/en-us/library/dd264996.aspx) in Visual Studio 2015. **Settings.StyleCop** is [not currently supported](https://github.com/DotNetAnalyzers/StyleCopAnalyzers/issues/892).
